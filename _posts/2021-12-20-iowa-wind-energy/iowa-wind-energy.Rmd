...
***Note****: This analysis was originally a Jupyter notebook which I ported over to an Rmd. You can view the analysis in its original format here:* [iowa-wind-energy.ipynb](files/iowa_wind_jupyter.html)  
