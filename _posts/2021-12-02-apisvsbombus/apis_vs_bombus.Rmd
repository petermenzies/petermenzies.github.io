...
description: |
  The following article details my statistical analysis of honeybee colonies and bumblebee occurrence in the US, using spatial interpolation and simple linear regression. 
author:
  - name: Peter Menzies
    url: {}
date: 12-02-2021
...
```{r, fig.align='center', fig.height=5, fig.cap="This scatterplot compares the mean number of managed honeybee hives per us County from agriculture census yeras 2002, 2007, and 2012 vs mean bumblebee occurrence per county derived from spatial interpolation of a national bee survey between 2007 and 2010."}
...
```{r, fig.cap="\nThis table presents the results of a simple linear regression of mean honeybee colonies per county on mean interpolated bumblebee occurrence per county. Discussion of the results is below.", out.width=500, fig.align='center', include=TRUE}
